...
\bibitem{a} \url{http://www.wilmott.com/messageview.cfm?catid=8&threadid=20290}
\bibitem{b} \url{http://www.cmat.edu.uy/~mordecki/hk/lecture24.pdf}
\bibitem{c} \url{http://www.opengamma.com/sites/default/files/caplet-stripping-opengamma.pdf}
\end{thebibliography}
\end{document}